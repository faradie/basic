...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    // Route::get('/modules/{id}/downloadModuleFiles', 'ModuleController@getAllModuleFiles');
    Route::get('/modules/{id}/deleteAllFiles', 'ModuleController@deleteAllFilesModule');
    Route::get('/modules/{id}/delete', 'ModuleController@fileDelete');
